...
Obrigado por considerar uma contribuição para **Toolkit de chaos engineering para bots de trading**.

## Como começar

1. Faça um fork do repositório [chaos-engineering-trading-toolkit](https://github.com/SrSatriano/chaos-engineering-trading-toolkit).
