# Arquitetura — Toolkit de chaos engineering para bots de trading

> Versão do documento: **1.0.0** · Última revisão: **2026-03-26**

## 1. Visão geral

Experimentos de latência, queda de DB e outage de broker.
...
|------------|------------------|
| Experimentos | Experimentos documentados |
| CLI | CLI chaosd |
| Relatórios | Relatórios de recuperação |
| Integração | Integração Docker |
| Métricas | Métricas de MTTR |
